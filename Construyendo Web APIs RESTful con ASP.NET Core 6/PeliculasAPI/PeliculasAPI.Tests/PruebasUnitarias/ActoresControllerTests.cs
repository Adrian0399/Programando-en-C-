...
namespace PeliculasAPI.Tests.PruebasUnitarias
{
    ...
    public class ActoresControllerTests : BasePruebas
    {
        ...
        public async Task CrearActorSinFoto()
        {
            ...
            var actor = new ActorCreacionDTO() { Nombre = "Adrian", FechaNacimiento = DateTime.Now };
        ...
        public async Task PatchActualizaUnSoloCampo()
        {
            ...
            var actor = new Actor() { Nombre = "Adrian", FechaNacimiento = fechaNacimiento };
            contexto.Add(actor);
            await contexto.SaveChangesAsync();
            ...
            var patchDoc = new JsonPatchDocument<ActorPatchDTO>();
            patchDoc.Operations.Add(new Operation<ActorPatchDTO>("replace", "/nombre", null, "Fany"));
            var respuesta = await controller.Patch(1, patchDoc);
            var resultado = respuesta as StatusCodeResult;
