...
namespace PeliculasAPI.Migrations
{
    ...
    [Migration("20221216011337_TablasIdentity")]
            ...
            modelBuilder.Entity("PeliculasAPI.Entidades.SalaDeCine", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 5,
                            Nombre = "Cinepolis Sendero",
                            Ubicacion = (NetTopologySuite.Geometries.Point)new NetTopologySuite.IO.WKTReader().Read("SRID=4326;POINT (19.2955454 -98.8840137)")
                        },
                        new
                        {
                            Id = 6,
                            Nombre = "Cinemex Ixtapaluca",
                            Ubicacion = (NetTopologySuite.Geometries.Point)new NetTopologySuite.IO.WKTReader().Read("SRID=4326;POINT (19.3128724 -98.8890045)")
                        },
                        new
                        {
                            Id = 7,
