...
namespace PeliculasAPI.Controllers
{
    public class CustomBaseController: ControllerBase
    {
            ...
            where TEntidad: class, IId
        {
            ...
            var entitdadDTO = mapper.Map<TDTO>(entidadDB);

            patchDocument.ApplyTo(entitdadDTO, ModelState);

            var esValido = TryValidateModel(entitdadDTO);
            ...
            mapper.Map(entitdadDTO, entidadDB);
