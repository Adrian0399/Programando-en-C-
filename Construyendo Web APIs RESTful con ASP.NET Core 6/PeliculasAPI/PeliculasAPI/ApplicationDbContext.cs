...
namespace PeliculasAPI
{
    public class ApplicationDbContext: IdentityDbContext
    {
        ...
        private void SeedData(ModelBuilder modelBuilder)
        {
            ...
            var username = "adrian03@hotmail.com";
            ...
            var usuarioAdmin = new IdentityUser()
            {
                ...
                PasswordHash = passwordHasher.HashPassword(null, "Kaibil57!")
            };
            ...
            modelBuilder.Entity<SalaDeCine>()
               .HasData(new List<SalaDeCine>
               {
                    ...
                    new SalaDeCine{Id = 5, Nombre = "Cinepolis Sendero", Ubicacion = geometryFactory.CreatePoint(new Coordinate(19.2955454, -98.8840137))},
                    new SalaDeCine{Id = 6, Nombre = "Cinemex Ixtapaluca", Ubicacion = geometryFactory.CreatePoint(new Coordinate(19.3128724, -98.8890045))},
